...
pub fn TableHeader(sort_by_field: SortByField, text: String) -> Element {
    ...
    let mut direction = storage.read().sort_by_direction.clone();
    ...
    rsx! {
        th {
            ...
            scope: "col",
            onclick: move |_| {
                direction = match storage.read().sort_by_direction {
            ...
            span {
                ...
                match storage.read().sort_by_direction {
...
pub fn StreakTable() -> Element {
    rsx! {
        div {
            class: "border-1 border-pink-100 rounded-lg dark:border-teal-700",
            table {
...
pub fn StreakTableBody() -> Element {
    ...
    let streaks = storage.read().get_sorted_streaks();
